...
<div class="container mt-4 ">
     <div class="row">
        <div class="col-md-6">
             <a href="" class="text-info bg-light p-2">YEAR 2019</a> &gt; <a href="" class="text-info bg-light p-2"> MONTH JANUARY</a> &gt; <a href="" class="text-info bg-light p-2">ADD ON COURSES </a>
        </div>
            ...
            <div class="container">
                    <div class="card">
                        <div class="card-header">
                             <h6>Add on courses / Training  Programme</h6>
                        </div>
                        ...
                        <?php include 'inserting/insertcourse.php' ?>
                    </div>
                </div>
        </div>
    </div>
