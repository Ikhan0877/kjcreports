...
<div class="container mt-4 ">
     <div class="row">
        <div class="col-md-6">
             <a href="" class="text-info bg-light p-2">YEAR 2019</a> &gt; <a href="" class="text-info bg-light p-2"> MONTH JANUARY</a> &gt; <a href="" class="text-info bg-light p-2">INTERCOLLEGIATE FEST</a>
        </div>
        <div class="col-md-6">
            ...
            <div class="container">
                    <div class="card ">
                        ...
                        <div class="card-body p-0 table-responsive">
                            <table class="table table-bordered  table-striped p-0 m-0">
                                    <tr class="table-info">
                                        ...
                                        <td class="p-0 text-center pt-2 text-lowercase">Name of participants
                                        </td>
                                        <td>prices won</td>
                        ...
                        <div class="card-footer p-0 bg-primary">
                            <a href="" class="btn d-block w-100 mx-auto">ADD</a>
                        </div>
                    </div>
                </div>
        </div>
